...
do
  ...
  export LOCAL_CONFIG_OPTIONS="--prefix=${TARGETDIR} --with-ssl=${OPENSSLDIR} --enable-ipv6 --host=${HOST} --disable-shared --enable-static --disable-manual -with-random=/dev/urandom"
